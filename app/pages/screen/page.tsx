...
const CreateScreenPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      <ToastContainer />
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Create Screen</h1>
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-6 w-full max-w-md">
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="name">Screen Name</label>
          <input
            type="text"
            name="name"
            value={screen.name}
        ...
        <fieldset className="mb-4">
          <legend className="block text-gray-700 text-sm font-bold mb-2">Screen Type</legend>
